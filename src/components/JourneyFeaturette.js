...
export default function JourneyFeaturette() {
    return (
        <div>
            <div className="row featurette d-flex flex-row-reverse align-items-center my-5 py-5 gap-4 gap-md-0">
                <div className="col-md-7 order-md-2" data-aos="fade-up">
                    ...
                    <p data-aos="fade-up" style={{filter:'blur(.75px)'}}>Soubhik first time confessed to Udhrity that he likes her, like really likes her.</p>
                    <p className="lead fw-bold mt-3 pb-0 mb-0 d-flex align-items-center gap-2" style={{ color: '#365c1e', filter:'blur(1.5px)' }} data-aos="fade-up"><span className="material-symbols-outlined">calendar_month</span>24th December,2023</p>
                    <p data-aos="fade-up"  style={{filter:'blur(3px)'}}>Our first movie date - "Pradhan" at Hiland Park.</p>
